  ...
  if (navigator.share) {
    navigator
      .share({
        title: "",
        text:
          "您可以阻止亞馬遜毀林！一齊聯署促請香港企業查明、公開所售肉品來源，同毀林肉商劃清界線，確保我哋喺店鋪購買嘅肉品唔涉及亞馬遜毀林，一齊行動保衛亞馬遜森林👉 ",
...
const whatsAppShare = (event) => {
  event.preventDefault();
  var w =
    "https://api.whatsapp.com/send?text=您可以阻止亞馬遜毀林！一齊聯署促請香港企業查明、公開所售肉品來源，同毀林肉商劃清界線，確保我哋喺店鋪購買嘅肉品唔涉及亞馬遜毀林，一齊行動保衛亞馬遜森林👉 https://act.gp/2DjK759";
  window.open(w);
};
